export default {
	initVariables: function () {
		...
		for (const [_ip, device] of Object.entries(self.devicesData)) {
					...
					for (let variableType of variableTypes) {
						switch (variableType) {
							...
							case 'manf': {
								...
								let versionString = device.productVersionString
									? device.productVersionString
									: '' +
										device.productVersionMajor +
										'.' +
										device.productVersionMinor +
										'.' +
